...
$data = array(
array('Mes Atual',  excelente(date('Y-m-d')),  bom(date('Y-m-d')),  regular(date('Y-m-d')), ruim(date('Y-m-d')), pessimo(date('Y-m-d')))// array('Fevereiro',  excelente('2020-02-13'),  bom('2020-02-13'),  regular('2020-02-13'), ruim('2020-02-13'), pessimo('2020-02-13')), array('Marco',  excelente('2020-03-13'),  bom('2020-03-13'),  regular('2020-03-13'), ruim('2020-03-13'), pessimo('2020-03-13')),
